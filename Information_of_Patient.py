#face recognition based patients information system
import tkinter
import tkinter.ttk
...
class InsertWindow:
    def __init__(self):
        ...
        self.window.wm_title("Insert Data's of Patient")
        bg_color = "Black"
        fg_color = "white"
    ...
    def Insert(self):
        ...
        if (self.test == "SUCCESS"):
            ...
            tkinter.messagebox.showinfo("Inserted data", "Successfully inserted the above data in the patient database")
        else:
...
class DatabaseView:
    def __init__(self, data):
        ...
        self.databaseViewWindow.wm_title("Patient Database")
...
class HomePage:
    def __init__(self):
        ...
        fg_color = "white"
        lbl_color = 'green'
        tkinter.Label(self.homePageWindow, relief=tkinter.GROOVE, fg=fg_color, bg=bg_color, text="Patient Information System", font=("times new roman",20,"bold"), width=30).grid(pady=20, column=1, row=1)
        ...
        tkinter.Button(self.homePageWindow, width=20, relief=tkinter.GROOVE, fg=fg_color, bg=bg_color, text="Exit", font=("times new roman",15,"bold"), command=self.homePageWindow.destroy).grid(pady=15,
                                                                                                             column=1,
                                                                                                             row=7)
        tkinter.Label(self.homePageWindow,width=40,relief=tkinter.GROOVE, fg=fg_color, bg=bg_color, text="Developed By Rafi and Mriganko").grid(pady=20, column=1, row=9)
